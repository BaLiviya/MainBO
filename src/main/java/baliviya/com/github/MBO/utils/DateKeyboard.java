package baliviya.com.github.MBO.utils;
...
public class DateKeyboard {
    ...
    public boolean isNext(String updateText) {
        ...
        if (updateText.equals(emptyValue) || updateText.equals(formatYear.format(startDay.getTime())) || updateText.equals(formatMonth.format(startDay.getTime()))) {
            return true;
        }
        return false;
    }
